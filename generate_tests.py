...
class TestGenerator:
    ...
    def generate_coverage_report_for_go(self):
        ...
        coverage_dir = repo_root / "generated_tests/go"
        report_out = coverage_dir / "coverage_report.out"
        report_html = coverage_dir / "coverage_report.html"

        try:
            logging.info("Running 'go test' in generated_tests/go/...")
            subprocess.run(
